...
| [IPFS](https://github.com/ipfs/ipfs) | 23.0k | Go, JavaScript | A peer-to-peer hypermedia protocol. |
...
| [Web3.js](https://github.com/web3/web3.js) | 19.9k | TypeScript | A collection of comprehensive TypeScript libraries for interaction with the Ethereum JSON RPC API and utility functions. |
